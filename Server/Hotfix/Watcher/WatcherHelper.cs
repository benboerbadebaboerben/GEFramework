...
namespace ET
{
    public static class WatcherHelper
    {
        public static StartMachineConfig GetThisMachineConfig()
        {
            ...
            foreach (StartMachineConfig config in ConfigComponent.Instance.Tables.StartMachineConfigCategory.DataMap.Values)
            {
        ...
        {
            StartProcessConfig startProcessConfig = ConfigComponent.Instance.Tables.StartProcessConfigCategory.Get(processId);
